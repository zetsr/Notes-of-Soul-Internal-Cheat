...
// WidgetBlueprintGeneratedClass WBP_ItemTipWithText.WBP_ItemTipWithText_C
// 0x0038 (0x0298 - 0x0260)
class UWBP_ItemTipWithText_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_WBP_ItemTipWithText(int32 EntryPoint);
	void Construct();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("WBP_ItemTipWithText_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"WBP_ItemTipWithText_C")
	}
	static class UWBP_ItemTipWithText_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_ItemTipWithText_C>();
	}
};
DUMPER7_ASSERTS_UWBP_ItemTipWithText_C;
