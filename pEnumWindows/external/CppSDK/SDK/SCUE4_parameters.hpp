...
// Function SCUE4.SCLibrary.MakeSafeString
// 0x0048 (0x0048 - 0x0000)
struct SCLibrary_MakeSafeString final
{
public:
	class FString                                 Input;                                             // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSafeString                            ReturnValue;                                       // 0x0010(0x0038)(Parm, OutParm, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_SCLibrary_MakeSafeString;
...
DUMPER7_ASSERTS_SafeGameInstanceSubsystem_HideGameGuardConsole;
