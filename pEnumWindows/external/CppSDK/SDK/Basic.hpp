...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04E3F650;
	constexpr int32 AppendString      = 0x011E2A70;
	constexpr int32 GNames            = 0x04E03300;
	constexpr int32 GWorld            = 0x04F87B70;
	constexpr int32 ProcessEvent      = 0x013D36C0;
