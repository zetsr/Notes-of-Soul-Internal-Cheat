...
public:
	...
	TArray<int64>                                 LongArrayValue;                                    // 0x0088(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class ULowEntryLong*>                  LongBytesArrayValue;                               // 0x0098(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 FloatArrayValue;                                   // 0x00A8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class ULowEntryDouble*>                DoubleBytesArrayValue;                             // 0x00B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<bool>                                  BooleanArrayValue;                                 // 0x00C8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         StringUtf8ArrayValue;                              // 0x00D8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
