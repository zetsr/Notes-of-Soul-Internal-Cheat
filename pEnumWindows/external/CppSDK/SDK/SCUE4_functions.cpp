...
struct FSafeString USCLibrary::MakeSafeString(const class FString& Input)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("SCLibrary", "MakeSafeString");

	Params::SCLibrary_MakeSafeString Parms{};
